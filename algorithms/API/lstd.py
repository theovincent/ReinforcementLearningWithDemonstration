...
def lstd_grid_word(
    ...
    for iteration in range(max_iteration):
        ...
        if regularisor_expert > 0:  # Add a constraint of the expert samples in the minimization
            u = optimise_u(env, replay_buffer.buffer_rl, w, regularisor_bellmann)
            ...
            u = optimise_u(env, replay_buffer.buffer_rl + replay_buffer.buffer_expert, w, regularisor_bellmann)
